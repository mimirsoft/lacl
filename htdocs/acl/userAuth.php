...
if(isset($_POST['username']) && isset($_POST['pass']) && isset($_POST['apikey']) && $_POST['apikey']=='cde3xsw2' && isset($_POST['application']) )
{
    ...
    */
	...
	$USER = New User2($_POST['username'], $_POST['pass']);
	if($USER->getAuthenticated()) 
    {	
		echo json_encode($USER->getUserArray());
    }
